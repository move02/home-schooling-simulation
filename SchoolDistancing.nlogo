...
to go
  ...
  if (days >= duration) [
    ...
    if(current-trial >= trial)[
      let fname (word "day" interval ".csv")
...
to update-time
  ...
  if ( hours = 12 ) [
    ...
    ask turtles with [group = time-for] [
      set all-met all-met + met
    ]

    set met-avg all-met / (count turtles)
  ...
  if(ticks mod 30 = 0) [
    ask turtles[
      ...
      if(status = "A") [
        ...
        if temp-result < (prob-of-symptom-appear * (after-exposed / (14 * 6 * 5))) [
          set color black
          set status "I"
        ]
        if temp-result >= (prob-of-symptom-appear * (after-exposed / (14 * 6 * 5))) [
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot infected-group1 + infected-group2"
"group1" 1.0 0 -4528153 true "" "plot infected-group1"
"group2" 1.0 0 -2382653 true "" "plot infected-group2"
...
true
false
"plotxy (days + current-trial * 200) (met-avg)" ""
PENS
"default" 1.0 0 -16777216 true "plotxy (days + current-trial * 200) (met-avg)" "plotxy (days + current-trial * 200) (met-avg)"
